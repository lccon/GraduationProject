...
<div id="updateCategoryDlg" class="container_24">
	<form id="maintainForm" method="post" action="${pageContext.request.contextPath }/categoryInfo/updateCategoryInfo.action">
		...
		<div class="grid_13">
			<input type="text" maxlength="32" name="cname" value="${category.cname}" class="form-txt">
		</div>
	</form>
</div>
